...
describe('inspectStream()', function() {
  ...
  it('works on a Stream', function(done: MochaDone) {
  ...
  it('works on a Readable Stream', function(done: MochaDone) {
  ...
  it('works on a Writable Stream', function(done: MochaDone) {
  ...
  it('works on a Duplex Stream', function(done: MochaDone) {
  ...
  it('works on a Transform Stream', function(done: MochaDone) {
  ...
  it('works on a PassThrough Stream', function(done: MochaDone) {
  ...
  it('works on a custom Stream', function(done: MochaDone) {
  ...
  it('returns nothing for a Buffer', function(done: MochaDone) {
  ...
  it('returns nothing for null', function(done: MochaDone) {
    const result = inspectStream(null);
    expect(result).toNotExist();
    done();
  });

  it('returns nothing for a String', function(done: MochaDone) {
